        ...
        <div className="max-w-6xl mx-auto">
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-6 mb-16">
            {[
              ...
              { value: '66%', label: 'Better mobile performance', sub: 'than average WordPress, Wix & Squarespace site' },
            ].map((stat, i) => (
              ...
              <div className="bg-[#162444] rounded-xl p-8 border border-white/5">
                ...
                <div className="space-y-4">
                  {[
                    ...
                    { step: '4', action: 'Structured all content for AI and search engine discovery' },
