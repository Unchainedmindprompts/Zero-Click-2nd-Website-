...
const faqPageSchema = {
  ...
  mainEntity: [
    ...
    },
    {
      ...
      acceptedAnswer: {
        '@type': 'Answer',
        text: 'For businesses that depend on local search visibility and AI citations, the switch consistently produces measurable improvements. Our custom Next.js sites typically deliver LCP scores under 1.5 seconds on mobile, PageSpeed Insights scores of 95 or higher, and full Core Web Vitals compliance — compared to typical WordPress scores of 35 to 50 on mobile performance.',
      },
    },
  ],
};
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-12">
            ...
            <article className="lg:col-span-2">
              <div className="prose-content font-poppins">
                ...
                <p className="text-[#8A9BB5] leading-relaxed mb-8">
                  The implication for WordPress sites is direct. If your site loads slowly, AI systems aren&apos;t just ranking you lower — they&apos;re effectively filtering you out of the citation pool entirely. The switch to a fast, clean technical foundation isn&apos;t a performance optimization. It&apos;s a prerequisite for AI search visibility. WordPress, in its current plugin-heavy state, doesn&apos;t meet that prerequisite for most local businesses. Custom Next.js consistently does.
                </p>
              ...
              <div className="sticky top-28 space-y-6">
                ...
                <div className="bg-[#162444] rounded-xl border border-[#D4A94A]/20 p-6">
                  ...
                  <p className="text-[#8A9BB5] text-sm font-poppins leading-relaxed mb-5">
                    We migrate sites from WordPress to custom Next.js — with zero downtime, improved rankings, and Core Web Vitals that pass every threshold.
                  </p>
