...
export const metadata: Metadata = {
  ...
  description:
    'Bloated plugins, slow Core Web Vitals, and poor technical structure are making WordPress sites invisible to AI search engines. Here\'s why Next.js wins — and what the numbers say.',
  openGraph: {
    title: 'Why WordPress Sites Are Losing the AI Search War',
    description:
...
const articleSchema = {
  ...
  wordCount: 900,
  keywords: 'WordPress AI search, Core Web Vitals, Next.js vs WordPress, plugin bloat, AI search visibility, schema markup, Next.js hosting, LCP benchmark',
  author: {
    '@type': 'Organization',
...
const faqPageSchema = {
  ...
  mainEntity: [
    ...
    },
    {
      ...
      acceptedAnswer: {
        '@type': 'Answer',
        text: 'For businesses that depend on local search visibility and AI citations, the switch consistently produces measurable improvements. Next.js typically delivers LCP scores under 1.5 seconds on mobile, PageSpeed Insights scores of 95 or higher, and full Core Web Vitals compliance — compared to typical WordPress, Wix, and Squarespace scores of 35 to 50 on mobile performance.',
      },
    },
  ],
};
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-12">
            ...
            <article className="lg:col-span-2">
              <div className="prose-content font-poppins">
                ...
                <div className="bg-[#162444] rounded-xl border border-white/5 p-6 my-8">
                  ...
                  <div className="grid grid-cols-2 gap-4">
                    ...
                    <div className="text-center p-4 bg-[#0F1E3C] rounded-lg border border-[#D4A94A]/20">
                      <p className="text-[#8A9BB5] text-sm font-poppins font-semibold mb-2">Next.js + Edge</p>
                ...
                <p className="text-[#8A9BB5] leading-relaxed mb-8">
                  The implication for WordPress, Wix, and Squarespace sites is direct. If your site loads slowly, AI systems aren&apos;t just ranking you lower — they&apos;re effectively filtering you out of the citation pool entirely. The switch to a fast, clean technical foundation isn&apos;t a performance optimization. It&apos;s a prerequisite for AI search visibility. Template-based platforms, in their typical plugin-heavy configurations, don&apos;t meet that prerequisite for most local businesses. Next.js consistently does.
                </p>
              ...
              <div className="sticky top-28 space-y-6">
                ...
                <div className="bg-[#162444] rounded-xl border border-white/5 p-6">
                  ...
                  <div className="space-y-4">
                    ...
                    <div>
                      <div className="flex justify-between mb-1">
                        <span className="text-[#8A9BB5] text-xs font-poppins">Next.js + Edge</span>
