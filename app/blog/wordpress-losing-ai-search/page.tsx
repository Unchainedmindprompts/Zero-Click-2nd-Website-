...
const faqPageSchema = {
  ...
  mainEntity: [
    ...
    },
    {
      ...
      acceptedAnswer: {
        '@type': 'Answer',
        text: 'For businesses that depend on local search visibility and AI citations, the switch consistently produces measurable improvements. Our custom Next.js sites typically deliver LCP scores under 1.5 seconds on mobile, PageSpeed Insights scores of 95 or higher, and full Core Web Vitals compliance — compared to typical WordPress, Wix, or Squarespace scores of 35 to 50 on mobile performance.',
      },
    },
  ],
};
      ...
      <section className="pt-36 pb-16 bg-[var(--d-bg)] px-4 relative overflow-hidden">
        ...
        <div className="max-w-4xl mx-auto relative z-10">
          ...
          <nav className="flex items-center gap-2 text-sm font-inter text-[var(--d-fg-dim)] mb-8">
            ...
            <span className="text-[var(--d-fg)] truncate">WordPress vs. AI Search</span>
          </nav>
          ...
          <h1 className="font-inter font-bold text-4xl md:text-5xl lg:text-6xl text-[var(--d-fg)] mb-6 leading-tight">
            ...
            <span className="text-[var(--d-accent)]">Losing the AI Search War</span>
          </h1>
          ...
          <div className="flex items-center gap-6 mt-8 pt-8 border-t border-[rgba(100,70,30,0.2)]">
            <div className="flex items-center gap-3">
              ...
              <div>
                ...
                <p className="text-[var(--d-fg-dim)] text-xs font-inter">January 22, 2026</p>
              </div>
            </div>
          </div>
        </div>
              ...
              <div className="prose-content font-inter">
                ...
                <div className="bg-[rgba(255,255,255,0.07)] rounded-xl border border-white/5 p-6 my-8">
                  ...
                  <div className="grid grid-cols-2 gap-4">
                    <div className="text-center p-4 bg-[var(--d-bg)] rounded-lg border border-white/5">
                      <p className="text-[var(--d-fg-dim)] text-sm font-inter font-semibold mb-2">WordPress + Shared Hosting</p>
                      <p className="text-red-400 font-bold text-2xl font-inter">4.8s</p>
                      <p className="text-[var(--d-fg-dim)] text-xs font-inter mt-1">Avg. LCP mobile</p>
                    </div>
                    <div className="text-center p-4 bg-[var(--d-bg)] rounded-lg border border-[rgba(100,70,30,0.2)]">
                      <p className="text-[var(--d-fg-dim)] text-sm font-inter font-semibold mb-2">Next.js + Edge Hosting</p>
                      <p className="text-[var(--d-accent)] font-bold text-2xl font-inter">1.2s</p>
                      <p className="text-[var(--d-fg-dim)] text-xs font-inter mt-1">Avg. LCP mobile</p>
                    </div>
                  </div>
                </div>
                ...
                <p className="text-[var(--d-fg-dim)] leading-relaxed mb-6">
                  Our hosting platform delivers pages from a globally distributed edge network — the same infrastructure used by companies like GitHub and Linear. When a user in your city requests your page, it&apos;s served from an edge node geographically close to them, not from a shared server in a distant data center. Time to First Byte averages under 50ms consistently, without the variance of shared hosting.
                </p>
                <p className="text-[var(--d-fg-dim)] leading-relaxed mb-6">
                  This matters for AI crawlers directly. Googlebot crawls from multiple geographic locations. When it crawls a site on edge infrastructure, every request returns fast and consistent TTFB. When it crawls a WordPress, Wix, or Squarespace site on shared or managed hosting, TTFB varies by server load, location, and time of day. Consistent crawl response is a quality signal — and our edge infrastructure provides it automatically, for every request.
                </p>
              ...
              <div className="sticky top-28 space-y-6">
                  ...
                  <div className="space-y-4">
                    <div>
                      <div className="flex justify-between mb-1">
                        <span className="text-[var(--d-fg-dim)] text-xs font-inter">WordPress/Wix/Squarespace avg.</span>
                        <span className="text-red-400 text-xs font-bold font-inter">38/100</span>
                      </div>
                      <div className="w-full bg-[var(--d-bg)] rounded-full h-2">
                        <div className="bg-red-400 h-2 rounded-full" style={{ width: '38%' }} />
                      </div>
                    </div>
                    <div>
                      <div className="flex justify-between mb-1">
                        <span className="text-[var(--d-fg-dim)] text-xs font-inter">Next.js + Edge Hosting</span>
                        <span className="text-[var(--d-accent)] text-xs font-bold font-inter">97/100</span>
                      </div>
                      <div className="w-full bg-[var(--d-bg)] rounded-full h-2">
                        <div className="bg-[var(--d-accent)] h-2 rounded-full" style={{ width: '97%' }} />
                      </div>
                    </div>
                    <p className="text-[var(--d-fg-dim)] text-xs font-inter pt-2">Mobile PageSpeed Insights performance score</p>
                  </div>
                </div>
                ...
                <div className="bg-[rgba(255,255,255,0.07)] rounded-xl border border-[rgba(100,70,30,0.2)] p-6">
                  ...
                  <p className="text-[var(--d-fg-dim)] text-sm font-inter leading-relaxed mb-5">
                    We migrate sites from WordPress, Wix, and Squarespace to custom Next.js — with zero downtime, improved rankings, and Core Web Vitals that pass every threshold.
                  </p>
      ...
      <section className="py-20 bg-[var(--d-bg)] px-4">
        <div className="max-w-3xl mx-auto text-center">
          ...
          <p className="text-[var(--d-fg-dim)] font-inter mb-8 leading-relaxed">
            A custom Next.js site isn&apos;t just faster — it&apos;s built to be cited by AI. Let&apos;s show you what your competitors with fast sites are doing that you&apos;re missing.
          </p>
