      ...
      <section className="pt-36 pb-16 bg-[#f8f5f0] px-4 relative overflow-hidden">
        ...
        <div className="max-w-4xl mx-auto relative z-10">
          ...
          <nav className="flex items-center gap-2 text-sm font-poppins text-[#6a5a48] mb-8">
            ...
            <span className="text-[#0a0806] truncate">WordPress vs. AI Search</span>
          </nav>

          <div className="flex items-center gap-3 mb-6">
            <span className="category-tag">Website Performance</span>
            <span className="text-[#6a5a48] text-sm font-poppins">6 min read</span>
          </div>
          ...
          <h1 className="font-playfair font-bold text-4xl md:text-5xl lg:text-6xl text-[#0a0806] mb-6 leading-tight">
            ...
            <span className="text-[#a0723a]">Losing the AI Search War</span>
          </h1>
          ...
          <div className="flex items-center gap-6 mt-8 pt-8 border-t border-[rgba(100,70,30,0.2)]">
            <div className="flex items-center gap-3">
              ...
              <div>
                ...
                <p className="text-[#6a5a48] text-xs font-poppins">January 22, 2026</p>
              </div>
            </div>
          </div>
        </div>
              ...
              <div className="prose-content font-poppins">
                ...
                <div className="bg-[#f2ede4] rounded-xl border border-white/5 p-6 my-8">
                  ...
                  <div className="grid grid-cols-2 gap-4">
                    <div className="text-center p-4 bg-[#f8f5f0] rounded-lg border border-white/5">
                      <p className="text-[#6a5a48] text-sm font-poppins font-semibold mb-2">WordPress + Shared Hosting</p>
                      <p className="text-red-400 font-bold text-2xl font-poppins">4.8s</p>
                      <p className="text-[#6a5a48] text-xs font-poppins mt-1">Avg. LCP mobile</p>
                    </div>
                    <div className="text-center p-4 bg-[#f8f5f0] rounded-lg border border-[rgba(100,70,30,0.2)]">
                      <p className="text-[#6a5a48] text-sm font-poppins font-semibold mb-2">Next.js + Edge Hosting</p>
                      <p className="text-[#a0723a] font-bold text-2xl font-poppins">1.2s</p>
                      <p className="text-[#6a5a48] text-xs font-poppins mt-1">Avg. LCP mobile</p>
                    </div>
                  </div>
                </div>
                ...
                <blockquote className="border-l-4 border-[#D4A94A] pl-6 my-8">
                  <p className="text-[#0a0806] text-xl font-semibold font-poppins leading-relaxed italic">
                  ...
                  <div className="space-y-4">
                    <div>
                      <div className="flex justify-between mb-1">
                        <span className="text-[#6a5a48] text-xs font-poppins">WordPress/Wix/Squarespace avg.</span>
                    ...
                    <div>
                      <div className="flex justify-between mb-1">
                        <span className="text-[#6a5a48] text-xs font-poppins">Next.js + Edge Hosting</span>
                        <span className="text-[#a0723a] text-xs font-bold font-poppins">97/100</span>
                      </div>
                      <div className="w-full bg-[#f8f5f0] rounded-full h-2">
                        <div className="bg-[#a0723a] h-2 rounded-full" style={{ width: '97%' }} />
                      </div>
                    </div>
                    <p className="text-[#6a5a48] text-xs font-poppins pt-2">Mobile PageSpeed Insights performance score</p>
                  </div>
                </div>
