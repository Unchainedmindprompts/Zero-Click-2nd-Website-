...
const articleSchema = {
  ...
  '@type': 'Article',
  '@id': 'https://www.kodecite.ai/blog/the-ai-search-stack-nobody-is-building-for-small-businesses#article',
  headline: 'The AI Search Stack Nobody Is Building for Small Businesses — And Why That\'s About to Change',
  description:
    'Enterprise SEO is built for enterprises. Subscription platforms are built for volume. Neither one gets you recommended by AI. Here\'s the gap in the market — and what fills it.',
  datePublished: '2026-03-13T00:00:00-07:00',
  dateModified: '2026-03-13T00:00:00-07:00',
  author: {
    '@type': 'Person',
      ...
      <section className="pt-36 pb-16 bg-[var(--d-bg)] px-4 relative overflow-hidden">
        ...
        <div className="max-w-4xl mx-auto relative z-10">
          ...
          <nav className="flex items-center gap-2 text-sm font-inter text-[var(--d-fg-dim)] mb-8">
            ...
            <span className="text-[var(--d-fg)] truncate">The AI Search Stack Nobody Is Building for Small Businesses</span>
          </nav>
          ...
          <h1 className="font-inter font-bold text-4xl md:text-5xl lg:text-6xl text-[var(--d-fg)] mb-6 leading-tight">
            ...
            <span className="text-[var(--d-accent)]">And Why That&apos;s About to Change</span>
          </h1>
          ...
          <div className="flex items-center gap-6 mt-8 pt-8 border-t border-[rgba(100,70,30,0.2)]">
            <div className="flex items-center gap-3">
              ...
              <div>
                ...
                <p className="text-[var(--d-fg-dim)] text-xs font-inter">March 13, 2026</p>
              </div>
            </div>
          </div>
        </div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-12">
            ...
            <article className="lg:col-span-2">
              <div className="prose-content font-inter">
                ...
                <h2 className="font-inter font-bold text-2xl text-[var(--d-fg)] mt-10 mb-6">
                  The Market Landscape at a Glance
                </h2>
                <div className="overflow-x-auto mb-8">
                  <table className="w-full text-sm font-inter border-collapse">
                    <thead>
                      <tr className="bg-[var(--d-bg-2)] text-[#f8f5f0]">
                    ...
                    <tbody>
                      {[
                        ...
                        <tr key={label} className={i % 2 === 0 ? 'bg-[var(--d-bg-2)]' : 'bg-[var(--d-bg)]'}>
                          <td className="p-3 font-semibold text-[var(--d-fg)]">{label}</td>
                          <td className="p-3 text-[var(--d-fg-dim)]">{col1}</td>
                          <td className="p-3 text-[var(--d-fg-dim)]">{col2}</td>
                          <td className="p-3 text-[var(--d-accent)] font-medium">{col3}</td>
                        </tr>
                      ))}
                    </tbody>
                  </table>
                ...
                <p className="text-[var(--d-fg-dim)] leading-relaxed mb-2">Next.js on Vercel&apos;s edge network delivers:</p>
                <ul className="list-none mb-6 space-y-2">
                  {[
                    ...
                    <li key={item} className="flex items-start gap-3 text-[var(--d-fg-dim)]">
                      <span className="mt-1.5 w-4 h-0.5 bg-[var(--d-accent)] flex-shrink-0 inline-block" />
                      <span>{item}</span>
                    </li>
                  ))}
                </ul>
                ...
                <h3 className="font-inter font-semibold text-xl text-[var(--d-fg)] mt-6 mb-4">
                  ...
                  <table className="w-full text-sm font-inter border-collapse">
                    ...
                    <tbody>
                      {[
                        ...
                        <tr key={time} className={i % 2 === 0 ? 'bg-[var(--d-bg-2)]' : 'bg-[var(--d-bg)]'}>
                          <td className="p-3 font-semibold text-[var(--d-fg)]">{time}</td>
                          <td className="p-3 text-[var(--d-fg-dim)]">{bounce}</td>
                          <td className="p-3 text-[var(--d-fg-dim)]">{conversion}</td>
                        </tr>
                      ))}
                    </tbody>
                  </table>
                </div>
                <p className="text-[var(--d-fg-dim)] text-sm italic mb-6">
                  Source: Google/Deloitte Mobile Speed Study; Core Web Vitals 2025–2026 benchmarks
                </p>

                <div className="bg-[rgba(255,255,255,0.14)] border-l-4 border-[var(--d-accent)] p-5 rounded-r-lg mb-8">
                  ...
                  <table className="w-full text-sm font-inter border-collapse">
                    ...
                    <tbody>
                      <tr className="bg-[var(--d-bg-2)]">
                        <td className="p-3 font-semibold text-[var(--d-fg)]">LCP (Largest Contentful Paint)</td>
                        <td className="p-3 text-[var(--d-accent)] font-medium">≤ 2.5 seconds</td>
                        <td className="p-3 text-[var(--d-fg-dim)]">How fast main content loads</td>
                      </tr>
                      <tr className="bg-[var(--d-bg)]">
                        <td className="p-3 font-semibold text-[var(--d-fg)]">INP (Interaction to Next Paint)</td>
                        <td className="p-3 text-[var(--d-accent)] font-medium">&lt; 200 milliseconds</td>
                        <td className="p-3 text-[var(--d-fg-dim)]">How fast the page responds to input</td>
                      </tr>
                      <tr className="bg-[var(--d-bg-2)]">
                        <td className="p-3 font-semibold text-[var(--d-fg)]">CLS (Cumulative Layout Shift)</td>
                        <td className="p-3 text-[var(--d-accent)] font-medium">&lt; 0.1</td>
                        <td className="p-3 text-[var(--d-fg-dim)]">Visual stability — does content jump around</td>
                      </tr>
                    </tbody>
                  </table>
                </div>
                ...
                <div className="overflow-x-auto mb-6">
                  <table className="w-full text-sm font-inter border-collapse">
                    ...
                    <tbody>
                      <tr className="bg-[var(--d-bg-2)]">
                        <td className="p-3 text-[var(--d-fg-dim)]">Enterprise platform site</td>
                        <td className="p-3 text-[var(--d-fg-dim)]">Varies</td>
                        <td className="p-3 text-[var(--d-fg-dim)]">Varies</td>
                        <td className="p-3 text-[var(--d-fg-dim)]">Can work if foundation is solid</td>
                      </tr>
                      <tr className="bg-[var(--d-bg)]">
                        <td className="p-3 text-[var(--d-fg-dim)]">WordPress / subscription builder</td>
                        <td className="p-3 text-[var(--d-fg-dim)]">40–65</td>
                        <td className="p-3 text-[var(--d-fg-dim)]">3–8 seconds</td>
                        <td className="p-3 text-[var(--d-fg-dim)]">Partial indexing, low citation</td>
                      </tr>
                      <tr className="bg-[var(--d-bg-2)]">
                        <td className="p-3 font-semibold text-[var(--d-fg)]">Next.js edge-deployed site</td>
                        <td className="p-3 text-[var(--d-accent)] font-medium">90–100</td>
                        <td className="p-3 text-[var(--d-accent)] font-medium">0.8–1.5 seconds</td>
                        <td className="p-3 text-[var(--d-accent)] font-medium">Complete indexing, citation-ready</td>
                      </tr>
                    </tbody>
                  </table>
                </div>
                ...
                <div className="bg-[rgba(255,255,255,0.14)] rounded-xl border border-white/5 p-6">
                  ...
                  <div className="space-y-4">
                    <div className="border-b border-[rgba(100,70,30,0.2)] pb-4">
                      <p className="text-[var(--d-accent)] font-bold text-3xl font-inter">90–100</p>
                      <p className="text-[var(--d-fg-dim)] text-sm font-inter mt-1">PageSpeed scores on edge-deployed sites</p>
                    </div>
                    <div className="border-b border-[rgba(100,70,30,0.2)] pb-4">
                      <p className="text-[var(--d-accent)] font-bold text-3xl font-inter">3×</p>
                      <p className="text-[var(--d-fg-dim)] text-sm font-inter mt-1">higher conversion rate at 1s vs. 5s load time</p>
                    </div>
                    <div>
                      <p className="text-[var(--d-accent)] font-bold text-3xl font-inter">3–5</p>
                      <p className="text-[var(--d-fg-dim)] text-sm font-inter mt-1">new clients per month — intentionally limited</p>
                    </div>
                  </div>
                </div>
