...
const articleSchema = {
  ...
  '@type': 'Article',
  '@id': 'https://www.kodecite.ai/blog/ai-overviews-local-businesses#article',
  headline: 'How to Get Your Local Business Featured in Google AI Overviews',
  description:
    'Google AI Overviews are replacing traditional search results for millions of queries. Here\'s the exact framework for getting local businesses cited as the source — not buried below it.',
  datePublished: '2026-02-18T00:00:00-07:00',
  dateModified: '2026-02-18T00:00:00-07:00',
  wordCount: 950,
  image: {
    '@type': 'ImageObject',
      ...
      <section className="pt-36 pb-16 bg-[var(--d-bg)] px-4 relative overflow-hidden">
        ...
        <div className="max-w-4xl mx-auto relative z-10">
          <nav className="flex items-center gap-2 text-sm font-inter text-[var(--d-fg-dim)] mb-8">
            ...
            <span className="text-[var(--d-fg)] truncate">AI Overviews for Local Businesses</span>
          </nav>
          ...
          <h1 className="font-inter font-bold text-4xl md:text-5xl lg:text-6xl text-[var(--d-fg)] mb-6 leading-tight">
            ...
            <span className="text-[var(--d-accent)]">Featured in Google AI Overviews</span>
          </h1>
          ...
          <div className="flex items-center gap-6 mt-8 pt-8 border-t border-[rgba(100,70,30,0.2)]">
            <div className="flex items-center gap-3">
              ...
              <div>
                ...
                <p className="text-[var(--d-fg-dim)] text-xs font-inter">February 18, 2026</p>
              </div>
            </div>
          </div>
        </div>
