      ...
      <section className="pt-36 pb-16 bg-[#0A1628] px-4 relative overflow-hidden">
        ...
        <div className="max-w-4xl mx-auto relative z-10">
          <nav className="flex items-center gap-2 text-sm font-poppins text-[#8A9BB5] mb-8">
            ...
            <span className="text-white truncate">The 2026 Digital Land Rush</span>
          </nav>
          ...
          <h1 className="font-poppins font-bold text-4xl md:text-5xl lg:text-6xl text-white mb-6 leading-tight">
            ...
            <span className="text-[#D4A94A]">Why Waiting on AI Visibility Could Cost Your Business Everything</span>
          </h1>
          ...
          <div className="flex items-center gap-6 mt-8 pt-8 border-t border-white/10">
            <div className="flex items-center gap-3">
              <div className="w-9 h-9 rounded-full bg-[#D4A94A] flex items-center justify-center">
                <span className="text-[#0F1E3C] font-bold text-sm font-poppins">MA</span>
              </div>
              <div>
                <p className="text-white text-sm font-semibold font-poppins">Mark Abplanalp</p>
                <p className="text-[#8A9BB5] text-xs font-poppins">March 7, 2026</p>
              </div>
            </div>
          </div>
        </div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-12">
            ...
            <article className="lg:col-span-2">
              <div className="prose-content font-poppins">
                ...
                <div className="bg-[#162444] rounded-xl border border-white/5 p-6 my-8">
                  ...
                  <div className="space-y-4">
                    {[
                      ...
                      <div key={item.period} className="flex items-start gap-4 p-4 bg-[#0F1E3C] rounded-lg border border-white/5">
                        <div className="flex-shrink-0 min-w-[90px]">
                          <p className="text-[#D4A94A] text-xs font-bold font-poppins">{item.period}</p>
                          <p className={`${item.color} text-sm font-semibold font-poppins`}>{item.label}</p>
                        </div>
                        <p className="text-[#8A9BB5] text-xs font-poppins leading-relaxed">{item.desc}</p>
                      </div>
                    ))}
                  </div>
                </div>
                ...
                <p className="text-[#8A9BB5] leading-relaxed mb-8">
                  <Link href="https://www.kodecite.ai" className="text-[#D4A94A] hover:underline">KodeCite.ai</Link> helps independent local and regional businesses build structured AI visibility through high-performance sites, machine-readable authority layers, and Answer Engine Optimization strategies that turn local expertise into permanent AI dominance.
                </p>

                <p className="text-[#8A9BB5] leading-relaxed mb-8">
                  Get your <Link href="/contact" className="text-[#D4A94A] hover:underline">free AEO Audit</Link> at <Link href="https://www.kodecite.ai" className="text-[#D4A94A] hover:underline">KodeCite.ai</Link>.
                </p>
                ...
                <div className="bg-[#162444] rounded-xl border border-white/5 p-6">
                  ...
                  <div className="space-y-4">
                    <div className="border-b border-white/10 pb-4">
                      <p className="text-[#D4A94A] font-bold text-3xl font-poppins">6mo</p>
                      <p className="text-[#8A9BB5] text-sm font-poppins mt-1">to first meaningful AI citations</p>
                    </div>
                    <div className="border-b border-white/10 pb-4">
                      <p className="text-[#D4A94A] font-bold text-3xl font-poppins">2–3×</p>
                      <p className="text-[#8A9BB5] text-sm font-poppins mt-1">more effort required if you wait 18–24 months</p>
                    </div>
                    <div>
                      <p className="text-[#D4A94A] font-bold text-3xl font-poppins">Now</p>
                      <p className="text-[#8A9BB5] text-sm font-poppins mt-1">the window is still open</p>
                    </div>
                  </div>
                </div>
      ...
      <section className="py-20 bg-[#0A1628] px-4">
        <div className="max-w-3xl mx-auto text-center">
          ...
          <p className="text-[#8A9BB5] font-poppins mb-8 leading-relaxed">
            ...
            <Link href="/contact" className="text-[#D4A94A] hover:underline">free AEO Audit</Link>{' '}
