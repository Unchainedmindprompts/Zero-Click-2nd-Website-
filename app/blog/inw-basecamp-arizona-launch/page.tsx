...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    url: 'https://zeroclickstrategies.com/blog/inw-basecamp-arizona-launch',
    type: 'article',
  },
};
...
const articleSchema = {
  ...
  mainEntityOfPage: {
    '@type': 'WebPage',
    '@id': 'https://zeroclickstrategies.com/blog/inw-basecamp-arizona-launch',
  },
};
...
const breadcrumbSchema = {
  ...
  itemListElement: [
    ...
    { '@type': 'ListItem', position: 2, name: 'Blog', item: 'https://zeroclickstrategies.com/blog' },
    {
      ...
      item: 'https://zeroclickstrategies.com/blog/inw-basecamp-arizona-launch',
    },
  ],
};
      ...
      <section className="pt-36 pb-16 bg-[#0A1628] px-4 relative overflow-hidden">
        ...
        <div className="max-w-4xl mx-auto relative z-10">
          <nav className="flex items-center gap-2 text-sm font-poppins text-[#8A9BB5] mb-8">
            ...
            <span className="text-white truncate">INW Basecamp Arizona Launch</span>
          </nav>
          ...
          <h1 className="font-poppins font-bold text-4xl md:text-5xl lg:text-6xl text-white mb-6 leading-tight">
            ...
            <span className="text-[#D4A94A]">The INW Basecamp Arizona Launch</span>
          </h1>
          ...
          <div className="flex items-center gap-6 mt-8 pt-8 border-t border-white/10">
            <div className="flex items-center gap-3">
              ...
              <div>
                ...
                <p className="text-[#8A9BB5] text-xs font-poppins">February 26, 2026</p>
              </div>
            </div>
          </div>
        </div>
