              ...
              <div className="prose-content font-poppins">
                ...
                <blockquote className="border-l-4 border-[#D4A94A] pl-6 my-8">
                  <p className="text-white text-xl font-semibold font-poppins leading-relaxed italic">
                    &ldquo;More than 60% of Google searches end without a click. If you&apos;re not the source being cited, you don&apos;t exist to that searcher.&rdquo;
                  </p>
                </blockquote>
                ...
                <p className="text-[#8A9BB5] leading-relaxed mb-6">
                  Beyond schema, your site needs to load fast (under 2.5 seconds to Largest Contentful Paint), have clean heading structure that machines can traverse, and contain content that directly and concisely answers questions your customers are actually asking. Not content written for algorithms. Content written as answers — in plain language, with clear context and specific details.
                </p>
                <p className="text-[#8A9BB5] leading-relaxed mb-8">
                  The businesses that will thrive in the next five years of search are not the ones with the most backlinks or the most content. They&apos;re the ones that look authoritative to a machine. That requires a different kind of website, a different content strategy, and a different technical foundation than what most businesses built in the WordPress era. Zero click search isn&apos;t the enemy — it&apos;s the new reality. The question is whether you&apos;re building for it.
                </p>
