      ...
      <section className="pt-36 pb-16 bg-[var(--d-bg)] px-4 relative overflow-hidden">
        ...
        <div className="max-w-4xl mx-auto relative z-10">
          ...
          <nav className="flex items-center gap-2 text-sm font-inter text-[var(--d-fg-dim)] mb-8">
            ...
            <span className="text-[var(--d-fg)] truncate">What Is Zero Click Search</span>
          </nav>
          ...
          <h1 className="font-inter font-bold text-4xl md:text-5xl lg:text-6xl text-[var(--d-fg)] mb-6 leading-tight">
            ...
            <span className="text-[var(--d-accent)]">Why Your Business Is Invisible</span>
          </h1>
          ...
          <div className="flex items-center gap-6 mt-8 pt-8 border-t border-[rgba(100,70,30,0.2)]">
            <div className="flex items-center gap-3">
              ...
              <div>
                ...
                <p className="text-[var(--d-fg-dim)] text-xs font-inter">January 15, 2026</p>
              </div>
            </div>
          </div>
        </div>
                ...
                <div className="bg-[rgba(255,255,255,0.14)] rounded-xl border border-white/5 p-6">
                  ...
                  <div className="space-y-4">
                    <div className="border-b border-[rgba(100,70,30,0.2)] pb-4">
                      ...
                      <p className="text-[var(--d-fg-dim)] text-sm font-inter mt-1">of Google searches end without a click</p>
                    </div>
                    <div className="border-b border-[rgba(100,70,30,0.2)] pb-4">
                      <p className="text-[var(--d-accent)] font-bold text-3xl font-inter">100M+</p>
                      <p className="text-[var(--d-fg-dim)] text-sm font-inter mt-1">daily queries on ChatGPT</p>
                    </div>
                    <div>
                      <p className="text-[var(--d-accent)] font-bold text-3xl font-inter">15M+</p>
                      <p className="text-[var(--d-fg-dim)] text-sm font-inter mt-1">monthly Perplexity users</p>
                    </div>
                  </div>
                </div>
