...
const articleSchema = {
  ...
  '@type': 'Article',
  '@id': 'https://www.kodecite.ai/blog/f1-framework-for-aeo#article',
...
const breadcrumbSchema = {
  '@context': 'https://schema.org',
  '@type': 'BreadcrumbList',
  '@id': 'https://www.kodecite.ai/blog/f1-framework-for-aeo#breadcrumb',
  itemListElement: [
    ...
    <>
      ...
      <section className="pt-36 pb-16 bg-[var(--d-bg)] px-4 relative overflow-hidden">
        ...
        <div className="max-w-4xl mx-auto relative z-10">
          <nav className="flex items-center gap-2 text-sm font-inter text-[var(--d-fg-dim)] mb-8">
            ...
            <svg className="w-3 h-3" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9 5l7 7-7 7" /></svg>
            <span className="text-[var(--d-fg)] truncate">The F1 Framework for AEO</span>
          </nav>
          ...
          <h1 className="font-inter font-bold text-4xl md:text-5xl lg:text-6xl text-[var(--d-fg)] mb-6 leading-tight">
            ...
            <span className="text-[var(--d-accent)]">Why Most Businesses Are Trying to Win the AI Race in an Economy Car</span>
          </h1>
          ...
          <div className="flex items-center gap-6 mt-8 pt-8 border-t border-[var(--d-line)]">
            <div className="flex items-center gap-3">
              ...
              <div>
                ...
                <p className="text-[var(--d-fg-dim)] text-xs font-inter">April 23, 2026</p>
              </div>
            </div>
          </div>
        </div>
      ...
      <section className="bg-[var(--d-bg)] px-4 pb-12">
        <div className="max-w-4xl mx-auto">
          <Image
            src="/images/f1-hero.png"
            alt="The F1 Framework for AEO — AI search visibility stack"
            width={1200}
            height={630}
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-12">
            ...
            <article className="lg:col-span-2">
              <div className="prose-content font-inter">
                ...
                <h2 className="font-inter font-bold text-2xl text-[var(--d-fg)] mt-10 mb-4">The AEO Stack, Mapped to F1</h2>
                ...
                <h3 className="font-inter font-bold text-xl text-[var(--d-fg)] mt-8 mb-4">Layer 1 — The Chassis is your Infrastructure</h3>
                ...
                <h3 className="font-inter font-bold text-xl text-[var(--d-fg)] mt-8 mb-4">Layer 2 — The Engine is your Entity Graph</h3>
                ...
                <p className="text-[var(--d-fg-dim)] leading-relaxed mb-6">
                  Run any regional or local SMB&apos;s website through a schema validator and the results are almost always ugly. Missing schema entirely. LocalBusiness markup with wrong categories. Person schema that doesn&apos;t link to Organization schema. Empty <code className="bg-[var(--d-bg-2)] px-1.5 py-0.5 rounded text-[var(--d-accent)] text-sm">sameAs</code> arrays. Review markup that doesn&apos;t match the reviews on the page. No Article schema on blog posts. No FAQPage schema on FAQ pages. No BreadcrumbList hierarchy. Basic mistakes stacked on top of each other.
                </p>
                ...
                <h3 className="font-inter font-bold text-xl text-[var(--d-fg)] mt-8 mb-4">Layer 3 — The Aero Package is your Content</h3>
                ...
                <h3 className="font-inter font-bold text-xl text-[var(--d-fg)] mt-8 mb-4">Layer 4 — The Graphics are your Mentions</h3>
                ...
                <h2 className="font-inter font-bold text-2xl text-[var(--d-fg)] mt-10 mb-4">Why the Industry Is Selling This Backwards</h2>
                ...
                <h2 className="font-inter font-bold text-2xl text-[var(--d-fg)] mt-10 mb-4">The Competitive Opening for Regional and Local Businesses</h2>
                ...
                <h2 className="font-inter font-bold text-2xl text-[var(--d-fg)] mt-10 mb-4">How to Actually Sequence the Work</h2>
                ...
                <ul className="space-y-4 mb-10">
                  {[
                    ...
                    <li key={step} className="flex items-start gap-4">
                      <span className="font-inter font-bold text-[var(--d-accent)] text-lg flex-shrink-0 mt-0.5">{step}</span>
                      <span className="text-[var(--d-fg-dim)] leading-relaxed">{detail}</span>
                    </li>
                  ))}
                </ul>
                ...
                <h2 className="font-inter font-bold text-2xl text-[var(--d-fg)] mt-10 mb-4">The Race Is Already Underway</h2>
                ...
                <div className="bg-[rgba(255,255,255,0.14)] rounded-xl border border-[var(--d-line-s)] p-6">
                  ...
                  <div className="space-y-4">
                    <div className="border-b border-[var(--d-line)] pb-4">
                      <p className="text-[var(--d-accent)] font-bold text-lg font-inter">Layer 1</p>
                      <p className="text-[var(--d-fg-dim)] text-sm font-inter mt-1"><strong className="text-[var(--d-fg)]">Chassis</strong> — Infrastructure, hosting, server-side rendering, crawlability</p>
                    </div>
                    <div className="border-b border-[var(--d-line)] pb-4">
                      <p className="text-[var(--d-accent)] font-bold text-lg font-inter">Layer 2</p>
                      <p className="text-[var(--d-fg-dim)] text-sm font-inter mt-1"><strong className="text-[var(--d-fg)]">Engine</strong> — Entity graph, schema markup, identity signals</p>
                    </div>
                    <div className="border-b border-[var(--d-line)] pb-4">
                      <p className="text-[var(--d-accent)] font-bold text-lg font-inter">Layer 3</p>
                      <p className="text-[var(--d-fg-dim)] text-sm font-inter mt-1"><strong className="text-[var(--d-fg)]">Aero</strong> — Answer-first content, FAQ sections, structured hierarchy</p>
                    </div>
                    <div>
                      <p className="text-[var(--d-accent)] font-bold text-lg font-inter">Layer 4</p>
                      <p className="text-[var(--d-fg-dim)] text-sm font-inter mt-1"><strong className="text-[var(--d-fg)]">Graphics</strong> — Mentions, press, directories, citations</p>
                    </div>
                  </div>
                </div>
                ...
                <div className="bg-[rgba(255,255,255,0.14)] rounded-xl border border-[var(--d-line-s)] p-6">
                  ...
                  <div className="space-y-4">
                    <Link href="/blog/below-the-content-layer" className="block group">
                      <p className="text-[var(--d-fg)] text-sm font-semibold font-inter leading-snug group-hover:text-[var(--d-accent)] transition-colors">Below The Content Layer — Where Your Real SEO, AEO &amp; GEO Opportunity Lives</p>
