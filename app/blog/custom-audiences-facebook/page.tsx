      ...
      <section className="pt-36 pb-16 bg-[#f8f5f0] px-4 relative overflow-hidden">
        ...
        <div className="max-w-4xl mx-auto relative z-10">
          <nav className="flex items-center gap-2 text-sm font-poppins text-[#6a5a48] mb-8">
            ...
            <span className="text-[#0a0806] truncate">Three Custom Audiences</span>
          </nav>
          ...
          <h1 className="font-playfair font-bold text-4xl md:text-5xl lg:text-6xl text-[#0a0806] mb-6 leading-tight">
            ...
            <span className="text-[#a0723a]">Local Business Needs on Facebook</span>
          </h1>
          ...
          <div className="flex items-center gap-6 mt-8 pt-8 border-t border-[rgba(100,70,30,0.2)]">
            <div className="flex items-center gap-3">
              ...
              <div>
                ...
                <p className="text-[#6a5a48] text-xs font-poppins">February 27, 2026</p>
              </div>
            </div>
          </div>
        </div>
                ...
                <div className="bg-[#f2ede4] rounded-xl border border-white/5 p-6">
                  ...
                  <div className="space-y-4">
                    <div className="border-b border-[rgba(100,70,30,0.2)] pb-4">
                      <p className="text-[#a0723a] font-bold text-sm font-poppins mb-1">Audience 1</p>
                      <p className="text-[#0a0806] text-sm font-semibold font-poppins">Video View Custom Audience</p>
                      <p className="text-[#6a5a48] text-xs font-poppins mt-1">50%+ and 75%+ view thresholds, segmented</p>
                    </div>
                    <div className="border-b border-[rgba(100,70,30,0.2)] pb-4">
                      <p className="text-[#a0723a] font-bold text-sm font-poppins mb-1">Audience 2</p>
                      <p className="text-[#0a0806] text-sm font-semibold font-poppins">Website Visitor Retargeting</p>
                      <p className="text-[#6a5a48] text-xs font-poppins mt-1">Pixel-based, segmented by page visited</p>
                    </div>
                    <div>
                      <p className="text-[#a0723a] font-bold text-sm font-poppins mb-1">Audience 3</p>
                      <p className="text-[#0a0806] text-sm font-semibold font-poppins">Customer Lookalike</p>
                      <p className="text-[#6a5a48] text-xs font-poppins mt-1">1% lookalike from customer email list</p>
                    </div>
                  </div>
                </div>
