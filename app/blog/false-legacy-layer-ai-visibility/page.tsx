      ...
      <section className="pt-36 pb-16 bg-[var(--d-bg)] px-4 relative overflow-hidden">
        ...
        <div className="max-w-4xl mx-auto relative z-10">
          <nav className="flex items-center gap-2 text-sm font-inter text-[var(--d-fg-dim)] mb-8">
            ...
            <span className="text-[var(--d-fg)] truncate">The False Legacy Layer</span>
          </nav>
          ...
          <h1 className="font-inter font-bold text-4xl md:text-5xl lg:text-6xl text-[var(--d-fg)] mb-6 leading-tight">
            ...
            <span className="text-[var(--d-accent)]">Why Your AI Mentions Today Could Disappear Tomorrow</span>
          </h1>
            ...
            <article className="lg:col-span-2">
              <div className="prose-content font-inter">
                ...
                <p className="text-[var(--d-fg-dim)] leading-relaxed mb-6">
                  ...
                  <Link href="/services" className="text-[var(--d-accent)] hover:underline">llms.txt</Link>{' '}
                  telling AI agents what the business does and who it serves. No{' '}
                  <Link href="/services" className="text-[var(--d-accent)] hover:underline">agent.json</Link>{' '}
                ...
                <div className="bg-[rgba(255,255,255,0.14)] rounded-xl border border-[var(--d-line-s)] p-6">
                  ...
                  <div className="space-y-4">
                    ...
                    <div>
                      ...
                      <p className="text-[var(--d-fg-dim)] text-sm font-inter mt-1">convert the placeholder into permanent authority</p>
                    </div>
                  </div>
                </div>
