...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    url: 'https://zeroclickstrategies.com/blog/facebook-ads-local-business-2026',
    type: 'article',
  },
};
...
const articleSchema = {
  ...
  mainEntityOfPage: {
    '@type': 'WebPage',
    '@id': 'https://zeroclickstrategies.com/blog/facebook-ads-local-business-2026',
  },
};
...
const breadcrumbSchema = {
  ...
  itemListElement: [
    ...
    { '@type': 'ListItem', position: 2, name: 'Blog', item: 'https://zeroclickstrategies.com/blog' },
    {
      ...
      item: 'https://zeroclickstrategies.com/blog/facebook-ads-local-business-2026',
    },
  ],
};
      ...
      <section className="pt-36 pb-16 bg-[#0A1628] px-4 relative overflow-hidden">
        ...
        <div className="max-w-4xl mx-auto relative z-10">
          <nav className="flex items-center gap-2 text-sm font-poppins text-[#8A9BB5] mb-8">
            ...
            <span className="text-white truncate">Facebook Ads: The Flywheel</span>
          </nav>

          <div className="flex items-center gap-3 mb-6">
            <span className="category-tag">Facebook Ads</span>
            <span className="text-[#8A9BB5] text-sm font-poppins">9 min read</span>
          </div>
          ...
          <h1 className="font-poppins font-bold text-4xl md:text-5xl lg:text-6xl text-white mb-6 leading-tight">
            ...
            <span className="text-[#D4A94A]">The Flywheel Method</span>
          </h1>
          ...
          <div className="flex items-center gap-6 mt-8 pt-8 border-t border-white/10">
            <div className="flex items-center gap-3">
              ...
              <div>
                ...
                <p className="text-[#8A9BB5] text-xs font-poppins">February 12, 2026</p>
              </div>
            </div>
          </div>
        </div>
              ...
              <div className="prose-content font-poppins">
                ...
                <div className="bg-[#162444] rounded-xl border border-white/5 p-6 my-8">
                  ...
                  <div className="space-y-3">
                    {[
                      { layer: 'Layer 1', name: 'Awareness', desc: 'Cold interest audiences — brand introduction, video views, pixel data accumulation', color: 'text-[#8A9BB5]' },
                ...
                <div className="bg-[#162444] rounded-xl border border-white/5 p-6">
                  ...
                  <div className="space-y-4">
                    <div className="border-b border-white/10 pb-4">
                      <p className="text-[#D4A94A] font-bold text-3xl font-poppins">6wk</p>
                      <p className="text-[#8A9BB5] text-sm font-poppins mt-1">to meaningful retargeting data</p>
                    </div>
                    <div className="border-b border-white/10 pb-4">
                      <p className="text-[#D4A94A] font-bold text-3xl font-poppins">60%</p>
                      <p className="text-[#8A9BB5] text-sm font-poppins mt-1">lower CPL: retargeting vs cold</p>
                    </div>
                    <div>
                      <p className="text-[#D4A94A] font-bold text-3xl font-poppins">1%</p>
                      <p className="text-[#8A9BB5] text-sm font-poppins mt-1">lookalike starting point</p>
                    </div>
                  </div>
                </div>
