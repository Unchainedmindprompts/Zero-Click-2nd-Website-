      ...
      <section className="pt-36 pb-16 bg-[var(--d-bg)] px-4 relative overflow-hidden">
        ...
        <div className="max-w-4xl mx-auto relative z-10">
          <nav className="flex items-center gap-2 text-sm font-inter text-[var(--d-fg-dim)] mb-8">
            ...
            <svg className="w-3 h-3" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9 5l7 7-7 7" /></svg>
            <span className="text-[var(--d-fg)] truncate">Your Site Feels Fast to You</span>
          </nav>
          ...
          <h1 className="font-inter font-bold text-4xl md:text-5xl lg:text-6xl text-[var(--d-fg)] mb-6 leading-tight">
            ...
            <span className="text-[var(--d-accent)]">But AI Crawlers See Something Very Different</span>
          </h1>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-12">
            ...
            <article className="lg:col-span-2">
              <div className="prose-content font-inter">
                ...
                <h2 className="font-inter font-bold text-2xl text-[var(--d-fg)] mt-10 mb-4">What a Cached Page Actually Is</h2>
                ...
                <h2 className="font-inter font-bold text-2xl text-[var(--d-fg)] mt-10 mb-4">What a Cold Load Actually Is</h2>
                ...
                <h2 className="font-inter font-bold text-2xl text-[var(--d-fg)] mt-10 mb-4">The Two Numbers That Tell the Real Story</h2>
                ...
                <div className="bg-[var(--d-bg-2)] rounded-xl border border-[var(--d-line)] p-6 my-8">
                  ...
                  <div className="space-y-2 font-inter text-sm">
                    <div className="flex gap-4 py-2 border-b border-[var(--d-line)]">
                      <span className="text-[var(--d-accent)] font-bold w-36 flex-shrink-0">What you see</span>
                      <span className="text-[var(--d-fg-dim)]">Fonts, CSS, images, and scripts already cached locally. Sub-second load every time. Feels fast because your browser did the work on a previous visit.</span>
                    </div>
                    <div className="flex gap-4 py-2">
                      <span className="text-[var(--d-accent)] font-bold w-36 flex-shrink-0">What AI sees</span>
                      <span className="text-[var(--d-fg-dim)]">No cache. Full DNS resolution. Server cold start. Every asset fetched from scratch under strict token and time budgets. Every visit is the first visit.</span>
                    </div>
                  </div>
                </div>
                ...
                <h2 className="font-inter font-bold text-2xl text-[var(--d-fg)] mt-10 mb-4">Why AI Crawlers Have No Patience for Slow Cold Loads</h2>
                ...
                <h2 className="font-inter font-bold text-2xl text-[var(--d-fg)] mt-10 mb-4">The Wearable Problem Makes This Even More Critical</h2>
                ...
                <h2 className="font-inter font-bold text-2xl text-[var(--d-fg)] mt-10 mb-4">What Cold-Load-Ready Infrastructure Actually Looks Like</h2>
                ...
                <h2 className="font-inter font-bold text-2xl text-[var(--d-fg)] mt-10 mb-4">The Test You Should Run Right Now</h2>
                ...
                <div className="bg-[var(--d-bg-2)] rounded-xl border border-[var(--d-line)] p-6">
                  ...
                  <div className="space-y-4">
                    <div className="border-b border-[var(--d-line)] pb-4">
                      ...
                      <p className="text-[var(--d-fg-dim)] text-sm font-inter mt-1">cached assets available to any AI crawler — ever</p>
                    </div>
                    <div className="border-b border-[var(--d-line)] pb-4">
                      <p className="text-[var(--d-accent)] font-bold text-3xl font-inter">3–6s</p>
                      <p className="text-[var(--d-fg-dim)] text-sm font-inter mt-1">extra cold-load latency on most WordPress and subscription-platform sites</p>
                    </div>
                    <div>
                      <p className="text-[var(--d-accent)] font-bold text-3xl font-inter">&lt;150ms</p>
                      <p className="text-[var(--d-fg-dim)] text-sm font-inter mt-1">Time to First Byte on edge-deployed Next.js — what AI crawlers actually need</p>
                    </div>
                  </div>
                </div>
                ...
                <div className="bg-[var(--d-bg-2)] rounded-xl border border-[var(--d-line)] p-6">
                  ...
                  <div className="space-y-4">
                    <Link href="/blog/2026-digital-land-rush-ai-visibility" className="block group">
                      <p className="text-[var(--d-fg)] text-sm font-semibold font-inter leading-snug group-hover:text-[var(--d-accent)] transition-colors">The 2026 Digital Land Rush: Why Waiting on AI Visibility Could Cost Your Business Everything</p>
                    ...
                    <div className="border-t border-[var(--d-line)] pt-4">
                      <Link href="/blog/video-authority-layer-ai-assets-2026" className="block group">
                        <p className="text-[var(--d-fg)] text-sm font-semibold font-inter leading-snug group-hover:text-[var(--d-accent)] transition-colors">Why Your Videos Stay Trapped on YouTube</p>
                        <p className="text-[var(--d-fg-dim)] text-xs font-inter mt-1">8 min read</p>
                      </Link>
                    </div>
                  </div>
