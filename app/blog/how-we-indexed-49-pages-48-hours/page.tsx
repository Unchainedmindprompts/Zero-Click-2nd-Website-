...
export default function Indexed49Pages() {
  return (
    <>
      ...
      <section className="pt-36 pb-16 bg-[#f8f5f0] px-4 relative overflow-hidden">
        ...
        <div className="max-w-4xl mx-auto relative z-10">
          ...
          <nav className="flex items-center gap-2 text-sm font-poppins text-[#6a5a48] mb-8">
            ...
            <span className="text-[#0a0806] truncate">49 Pages in 48 Hours</span>
          </nav>
          ...
          <h1 className="font-playfair font-bold text-4xl md:text-5xl lg:text-6xl text-[#0a0806] mb-6 leading-tight">
            How We Indexed{' '}
            <span className="text-[#a0723a]">49 New Pages in 48 Hours</span>
          </h1>
          ...
          <div className="flex items-center gap-6 mt-8 pt-8 border-t border-[rgba(100,70,30,0.2)]">
            <div className="flex items-center gap-3">
              ...
              <div>
                ...
                <p className="text-[#6a5a48] text-xs font-poppins">February 1, 2026</p>
              </div>
            </div>
          </div>
        </div>
      ...
      {/* Results Banner */}
      <section className="py-10 bg-[#f2ede4] px-4 border-b border-white/5">
        <div className="max-w-5xl mx-auto">
          <div className="grid grid-cols-2 md:grid-cols-4 gap-6 text-center">
            <div>
              <p className="text-[#a0723a] font-bold text-4xl font-poppins">49</p>
              <p className="text-[#6a5a48] text-sm font-poppins mt-1">Net-new pages indexed</p>
            </div>
            <div>
              <p className="text-[#a0723a] font-bold text-4xl font-poppins">48h</p>
              <p className="text-[#6a5a48] text-sm font-poppins mt-1">Time to full index</p>
            </div>
            <div>
              <p className="text-[#a0723a] font-bold text-4xl font-poppins">4</p>
              <p className="text-[#6a5a48] text-sm font-poppins mt-1">Rich result types</p>
            </div>
            <div>
              <p className="text-[#a0723a] font-bold text-4xl font-poppins">0</p>
              <p className="text-[#6a5a48] text-sm font-poppins mt-1">Schema errors</p>
            </div>
          </div>
        </div>
      </section>
