...
export default function sitemap(): MetadataRoute.Sitemap {
  ...
  return [
    ...
    { url: `${baseUrl}/blog/what-is-an-entity-graph`, lastModified: new Date('2026-08-03').toISOString(), changeFrequency: 'monthly', priority: 0.8 },
    ...
    { url: `${baseUrl}/blog/false-legacy-layer-ai-visibility`, lastModified: new Date('2026-08-03').toISOString(), changeFrequency: 'monthly', priority: 0.8 },
    ...
    { url: `${baseUrl}/blog/aeo-geo-making-seo-better`, lastModified: new Date('2026-08-03').toISOString(), changeFrequency: 'monthly', priority: 0.8 },
    ...
    { url: `${baseUrl}/blog/how-to-rank-in-google-ai-overviews-for-local-businesses`, lastModified: new Date('2026-08-03').toISOString(), changeFrequency: 'monthly', priority: 0.9 },
    { url: `${baseUrl}/blog/why-is-my-website-traffic-dropping-2026`, lastModified: new Date('2026-08-03').toISOString(), changeFrequency: 'monthly', priority: 0.8 },
    ...
    { url: `${baseUrl}/blog/what-is-zero-click-search`, lastModified: new Date('2026-08-03').toISOString(), changeFrequency: 'monthly', priority: 0.8 },
