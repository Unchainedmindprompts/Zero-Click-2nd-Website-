...
export const metadata: Metadata = {
  ...
  description:
    'Based in North Idaho. KodeCite builds owned infrastructure that lets AI understand, verify, recommend, and take the next safe step with a service business — here or anywhere.',
