    ...
    itemListElement: [
      {
        ...
        itemOffered: {
          ...
          description: 'Fast, clean Next.js sites on Vercel built for AI discoverability.',
        },
        price: '2500',
        priceCurrency: 'USD',
      },
...
const faqSchema = {
  ...
  mainEntity: [
    ...
    },
    {
      ...
      acceptedAnswer: {
        '@type': 'Answer',
        text: 'Technical SEO and schema results can appear in days to weeks — our clients see desktop PageSpeed scores of 93–100 and validated schema from day one. Facebook ad campaigns typically generate initial data within the first week. Full organic traction from content builds over 60–90 days.',
      },
    },
    {
      '@type': 'Question',
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
            <ScrollReveal>
              <div>
                ...
                <p className="text-[#8A9BB5] leading-relaxed font-poppins mb-6">
                  We build every site on <strong className="text-white">Next.js</strong> — the same stack used by the fastest sites
            ...
            <ScrollReveal delay={200}>
              <div className="bg-[#162444] rounded-2xl p-8 border border-[#D4A94A]/20">
                <h3 className="font-poppins font-bold text-lg text-white mb-6">The Next.js Advantage</h3>
                <div className="space-y-6">
                  {[
                    ...
                    { label: 'Uptime', value: '99.99%', desc: 'Next.js SLA for production deployments' },
                  ].map((stat) => (
          ...
          <div className="space-y-4">
            {[
              ...
              },
              {
                ...
                a: 'WordPress is bloated, slow, and dependent on plugins that conflict with each other and break Core Web Vitals scores. Next.js loads faster, scores higher on Lighthouse, and is far easier for AI crawlers to parse and index. For AI search visibility, technical performance is no longer optional.',
              },
              {
              ...
              },
              {
                ...
                a: 'Technical SEO and schema results can appear in days to weeks — our clients see desktop PageSpeed scores of 93–100 and validated schema from day one. Facebook ad campaigns typically generate initial data within the first week. Full organic traction from content builds over 60–90 days.',
              },
              {
